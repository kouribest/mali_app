...
class Command(BaseCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.owner_field= self.DomainModel._meta.get_field('owner')
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--%s' % 'owner', dest='owner', default=None,
            help='Specifies the owner',
        )
    ...
    def handle(self, *args, **options):
        ...
        verbose_owner_field_name= self.owner_field.verbose_name
        ...
        try:
            ...
            while owner is None:
                input_msg= '%s: ' % capfirst(verbose_owner_field_name)
                try:
                    owner= User.objects.get(username= self.get_input_data(self.name_field, input_msg))
